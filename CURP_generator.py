...
#This script demonstrates how a CURP can be generated
#using basic personal information and Python logic.
#Author: Claudia Reyes
#Purpose: Educational practice. Show skills in string manipulation, input and output 
